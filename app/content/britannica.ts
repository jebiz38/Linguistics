...
export const CLASS_VIDEOS = {
  title: "말하기 수업",
  philosophy: {
    lead: "단순 암기와 문제 풀이는 뇌의 단기 기억 장치만 자극할 뿐, 언어 습득 장치(LAD)를 깨우지 못합니다. 텍스트를 심층적으로 이해하는 고차원적 입력(Input)과, 내 논리로 청중을 설득하는 의미 있는 출력(Output)의 전 과정이야말로 뇌의 언어 지도를 바꾸는 유일한 지표입니다.",
    warning: "점수라는 허상을 좇지 마십시오.",
    emphasis: "언어학적 본질을 쥐어주면, 성적은 알아서 압도적인 결과로 증명됩니다.",
  },
  intro:
