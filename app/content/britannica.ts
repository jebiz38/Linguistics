...
export const CLASS_VIDEOS = {
  title: "말하기 수업",
  philosophy: {
    body: "단편적인 텍스트 파편을 짜 맞추는 문제 풀이 기술은 아이의 미래에 아무런 무기가 되지 못합니다. 영어라는 낯선 세계의 글을 읽고 분석하며, 내 논리로 청중을 설득하는 '발표와 스피치'의 과정이야말로 진정한 언어적 성장을 증명하는 지표입니다. 점수라는 허상을 좇지 마십시오. ",
    emphasis: "언어의 본질을 쥐어주면, 성적은 알아서 압도적인 결과로 증명",
    closing: "됩니다.",
  },
  intro:
