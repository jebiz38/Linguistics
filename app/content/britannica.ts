...
export const CLASS_VIDEOS = {
  ...
  philosophy: {
    lead: [
      "단순 암기와 문제 풀이는 뇌의 단기 기억 장치만 자극할 뿐, 언어 습득 장치(LAD)를 깨우지 못합니다.",
      "텍스트를 심층적으로 이해하는 고차원적 입력(Input)과, 내 논리로 청중을 설득하는 의미 있는 출력(Output)의 전 과정이야말로 뇌의 언어 지도를 바꾸는 유일한 지표입니다.",
    ],
